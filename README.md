...
│   ├── _layout.tsx               # Root layout: fonts, splash screen, context providers
│   ├── index.tsx                 # Auth gate & routing logic
│   ├── (auth)/                   # Authentication & Onboarding
│   │   ├── welcome.tsx           # "Our Manifesto" welcome screen
│   │   ├── onboarding.tsx        # Deep Reader Persona Quiz
│   │   ├── login.tsx             # Sign in
│   │   └── register.tsx          # Account registration
│   ├── (tabs)/                   # 5 Bottom Tabs
│   │   ├── _layout.tsx           # Bottom tab bar & desktop sidebar
│   │   ├── home.tsx              # Home / Starting world & carousels
│   │   ├── swipe.tsx             # "Swipe Your Stars" discovery
│   │   ├── tbr.tsx               # TBR & Connected Library
│   │   ├── club.tsx              # Book Clubs & Circles
│   │   └── settings.tsx          # "Your Orbit" Settings
│   └── (stack)/                  # Modal and detail screens
│       ├── book/[id].tsx         # Book details & AI Quick Take
│       └── club/[id].tsx         # Inside a Circle discussion room
├── src/
│   ├── components/               # Atomic UI components
│   │   ├── ui/                   # Typography, Button, Card, Badge, EmptyState
│   │   ├── book/                 # BookCard, BookSwipeCard
│   │   └── circle/               # CirclePostCard, ReactionSelector
│   ├── constants/                # Brand colors (Gold & Blue), 8 sky themes
│   ├── context/                  # ThemeContext & AuthContext
│   ├── mock/                     # Typed books, clubs, comments, and posts
│   ├── services/                 # Centralized Claude AI client
│   └── types/                    # Shared TypeScript interfaces
├── AGENTS.md                     # Directives & Expo v54 rules
└── agent.md                      # Comprehensive single source of truth (PRD)
```
